...
interface SignupformProps {
  createAccount: (formData: FormData) => Promise<{ error?: string }>
}

function Signupform({createAccount}: SignupformProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col w-full h-full pl-32 lg:pl-20 md:pl-10 sm:pl-0 items-center justify-center space-y-4">

...
import NewSynopsis from '@/components/popup/NewSynopsis';
...
function Draft({params}: Props) {
  ...
  useEffect(() => {
    if(id){
      fetchChapterInfo(id, setChapterCount, setChapters, setImageFile, setTitle, setUserId, setBookGenres, setOldSynopsis);
    }
  }, [id, genres, title])

  const handleConfirm = async () => {
    editDraftSynopsis(id, newSynopsis);
    setSynopsis(false);
  }
